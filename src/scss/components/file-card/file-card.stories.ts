      ...
      <div class="iati-file-card-table__cards">
        <div class="iati-file-card">
          <div class="iati-file-card__main-row">
            <div class="iati-file-card__cell iati-file-card__cell--strong">Africalia-Activities</div>
          ...
          <div class="iati-file-card__details-row">
            <div class="iati-file-card__cell iati-file-card__cell--muted">Package details</div>
            <div class="iati-file-card__cell iati-file-card__cell--muted">Activity count</div>
            <div class="iati-file-card__cell iati-file-card__cell--muted">Org count</div>
            <div class="iati-file-card__cell iati-file-card__cell--muted">Total size</div>
            <div class="iati-file-card__cell iati-file-card__cell--muted">IATI version</div>
          </div>
          <div class="iati-file-card__footer-row">
            ...
            <div class="iati-file-card__actions">
              <button class="iati-button iati-button--submit iati-button--compact">
                <i class="iati-icon iati-icon--download"></i>
                <span>Download</span>
              </button>
              <button class="iati-button iati-button--outline iati-button--compact">
                View Details
              </button>
            </div>
          </div>
        ...
        <div class="iati-file-card">
          <div class="iati-file-card__main-row">
            <div class="iati-file-card__cell iati-file-card__cell--strong">Alcis-Am</div>
        ...
        <div class="iati-file-card">
          <div class="iati-file-card__main-row">
            <div class="iati-file-card__cell iati-file-card__cell--strong">Africalia-Org</div>
            <div class="iati-file-card__cell">1</div>
            <div class="iati-file-card__cell">0</div>
            <div class="iati-file-card__cell">14.89 kb</div>
            <div class="iati-file-card__cell">2.03</div>
  ...
  render: () => html`
    <div class="iati-file-card-table">
      ...
      <div class="iati-file-card-table__cards">
        <div class="iati-file-card">
          <div class="iati-file-card__main-row">
            <div class="iati-file-card__cell iati-file-card__cell--strong">Example-Package</div>
